...
url = ("https://api.darksky.net/forecast/{}/{}?units=si".format(config.dark_sky, config.melbourne_location))
...
if Temperature.cold.value < (max_temp) < Temperature.nice.value and (risk_of_rain) < Temperature.chance_of_rain.value:
